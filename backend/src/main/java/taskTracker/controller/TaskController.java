...
public class TaskController {
    ...
    public ResponseEntity<String> listDoneTasks() {
        try {
            String result = commandDispatcher.dispatch("list", new String[]{"done"});
            return ResponseEntity.ok(result);
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(e.getMessage());
        }
    ...
    public ResponseEntity<String> listTodoTasks() {
        try {
            String result = commandDispatcher.dispatch("list", new String[]{"todo"});
            return ResponseEntity.ok(result);
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(e.getMessage());
        }
    ...
    public ResponseEntity<String> listInProgressTasks() {
        try {
            String result = commandDispatcher.dispatch("list", new String[]{"in-progress"});
            return ResponseEntity.ok(result);
        } catch (Exception e) {
            return ResponseEntity.badRequest().body(e.getMessage());
        }
